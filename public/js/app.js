...
window.shiki = __webpack_require__(/*! shiki */ "./node_modules/shiki/dist/index.esm.js");
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BUNDLED_LANGUAGES": () => (/* binding */ languages),
/* harmony export */   "BUNDLED_THEMES": () => (/* binding */ themes),
/* harmony export */   "FontStyle": () => (/* binding */ FontStyle),
/* harmony export */   "getHighlighter": () => (/* binding */ getHighlighter),
/* harmony export */   "loadTheme": () => (/* binding */ fetchTheme),
/* harmony export */   "renderToHtml": () => (/* binding */ renderToHtml),
/* harmony export */   "setCDN": () => (/* binding */ setCDN),
/* harmony export */   "setOnigasmWASM": () => (/* binding */ setOnigasmWASM),
/* harmony export */   "setWasm": () => (/* binding */ setWasm),
/* harmony export */   "toShikiTheme": () => (/* binding */ toShikiTheme)
/* harmony export */ });
/* harmony import */ var vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vscode-oniguruma */ "./node_modules/vscode-oniguruma/release/main.js");
/* harmony import */ var vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var vscode_textmate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vscode-textmate */ "./node_modules/vscode-textmate/release/main.js");
/* harmony import */ var vscode_textmate__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vscode_textmate__WEBPACK_IMPORTED_MODULE_1__);
    ...
    if (!_onigurumaPromise) {
        ...
        if (isBrowser) {
            if (typeof WASM === 'string') {
                loader = (0,vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__.loadWASM)({
                    data: await fetch(_resolvePath('dist/onig.wasm')).then(r => r.arrayBuffer())
                });
            }
            else {
                loader = (0,vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__.loadWASM)(WASM);
            }
        }
        else {
            const path = __webpack_require__(/*! path */ "?7d66");
            const wasmPath = path.join(/*require.resolve*/(/*! vscode-oniguruma */ "./node_modules/vscode-oniguruma/release/main.js"), '../onig.wasm');
            const fs = __webpack_require__(/*! fs */ "?6db5");
            const wasmBin = fs.readFileSync(wasmPath).buffer;
            loader = (0,vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__.loadWASM)(wasmBin);
        }
        _onigurumaPromise = loader.then(() => {
            return {
                createOnigScanner(patterns) {
                    return (0,vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__.createOnigScanner)(patterns);
                },
                createOnigString(s) {
                    return (0,vscode_oniguruma__WEBPACK_IMPORTED_MODULE_0__.createOnigString)(s);
                }
            };
        });
    }
...
function tokenizeWithTheme(theme, colorMap, fileContents, grammar, options) {
    ...
    let ruleStack = vscode_textmate__WEBPACK_IMPORTED_MODULE_1__.INITIAL;
    let actual = [];
    let final = [];
...
class Registry extends vscode_textmate__WEBPACK_IMPORTED_MODULE_1__.Registry {
